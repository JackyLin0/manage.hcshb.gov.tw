...
<%
  InputStream mfile = new FileInputStream("/webapps/class3.XLS");
  ...
  for ( int s=0; s<1; s++ ) {
	  ...
	  for ( int i=1; i<rsRows; i++ ) {
		  ...
		  Cell c61 = rs.getCell(6,i);
		  String strc61 = c61.getContents();
		  ...
		  obj.setClassno3(strc41);
		  obj.setClasscname(strc51);
		  obj.setClassename(strc61);

		  boolean rtn = obj.create3();
		  if ( !rtn ) {
