...
<%
  ...
  <%}else{
	  ...
	  for ( int i=0; i<ary_delno.length; i++ ) {
		  VolunteerData qfile = new VolunteerData();
		  ArrayList<Object> qdels = qfile.findBydel("VolunteerFile",ary_delno[i]);	  
		  int delrcount = qfile.getAllrecordCount();
		  if ( qdels != null ) {
			  for ( int d=0; d<delrcount; d++ ) {
				  VolunteerData qdel = ( VolunteerData )qdels.get( d );
	  ...
	  VolunteerData obj = new VolunteerData();
	...
	<form name="mform" action="volunteer101.jsp" method="post">
