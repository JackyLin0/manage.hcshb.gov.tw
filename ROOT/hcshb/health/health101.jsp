...
<script>
  function add()
  {
    document.mform.action="health101_add.jsp";
  ...
  function qry()
  {
    document.mform.action="health101.jsp";
    document.mform.method="post";
    document.mform.submit();
  }  
  ...
  function mdy(serno)
  {
     ...
     document.mform.action="health101_mdy.jsp";
     document.mform.method="post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="health101_del.jsp?type=0";
        document.mform.method="post";
        document.mform.submit();
     } 
  } 
...
<%
  ...
  HealthData query = new  HealthData();    
...
<div>
  ...
  <jsp:include page="../../pubprogram/qclass.jsp">
      ...
      <jsp:param name="tablename" value="HealthClass"/>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	HealthData qlist = ( HealthData )qlists.get( i ); %>
