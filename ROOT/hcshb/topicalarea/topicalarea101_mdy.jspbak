...
<%
  ...
  TopicalAreaData query = new TopicalAreaData();  
...
<script>
  function back()
  {
     document.backform.action="topicalarea101.jsp";
  ...
  function save()
  {
     ...
     if ( document.mform.relateurl.value == 'http://' || document.mform.relateurl.value == '' )
     {
        ...
        return;
     }else if ( document.mform.relateurl.value.length > 200 ) {
     ...
     document.mform.action = "topicalarea101_mdysave.jsp";
  ...
  function del()
  {
     ...
     if(x)
     {
        ...
        document.backform.action="topicalarea101_del.jsp?type=1";
        document.backform.method="post";
        document.backform.submit();
     } 
  }           
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
    ...
    <td class="T12b">
      ...
      <%
        if ( oserverfile1 != null && !oserverfile1.equals("") ) {
        	...
        	<br><br><span class="T10">【原圖片檔名】：<a href="../../downdoc?file=/<%=java.net.URLEncoder.encode(query.getServerfile(),"UTF-8")%>&flag=topicalpath"><%=oclientfile1%></a></span><br>
        	<%
        	  if ( query.getImagemagick() != null && !query.getImagemagick().equals("null") && !query.getImagemagick().equals("") ) { %>
        		  <img src="../../downdoc?file=/<%=java.net.URLEncoder.encode(msfile,"UTF-8")%>&flag=topicalpath" alt="<%=query.getExpfile()%>" border="0"/>
    	      <%}else{%>
    	    	  <img src="../../showimage?file=/<%=java.net.URLEncoder.encode(msfile,"UTF-8")%>&flag=topicalpath&w=173&h=50" alt="<%=query.getExpfile()%>" border="0"/>
    	      <%}
        }%>
        ...
        <br><span class="T10">【建議圖片尺寸118*58】</span>
    </td>
  ...
  <tr>
    ...
    <td colspan="3">
      <input name="relateurl" type="text" class="lInput01" value="<%=query.getRelateurl()%>" size="42" maxlength="200" />&nbsp;
