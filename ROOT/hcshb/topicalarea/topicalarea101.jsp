...
<script>
  function add()
  {
    document.mform.action="topicalarea101_add.jsp";
  ...
  function qry()
  {
    document.mform.action="topicalarea101.jsp";
    document.mform.method="post";
    document.mform.submit();
  }  
  ...
  function mdy(serno)
  {
     ...
     document.mform.action="topicalarea101_mdy.jsp";
     document.mform.method="post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="topicalarea101_del.jsp?type=0";
        document.mform.method="post";
        document.mform.submit();
     } 
  } 
...
<%
  ...
  ArrayList qlists = query.findByday(table,keyword,sdate1,sdate2);  
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	TopicalAreaData qlist = ( TopicalAreaData )qlists.get( i ); %>
