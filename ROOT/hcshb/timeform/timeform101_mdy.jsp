...
<script>
  ...
  function save()
  {
     ...
     document.mform.action = "timeform101_mdysave.jsp";
     document.mform.method = "post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="timeform101_del.jsp?type=1";
        document.mform.method="post";
        document.mform.submit();
     } 
  }           
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <tr class="tr">
    ...
    <td colspan="3"><textarea name="content" cols="80" rows="10"><%=query.getContent()%></textarea></td>
  </tr>
  <tr>
