...
<script>
  function add()
  {
    document.mform.action="onlineapplication101_add.jsp";
  ...
  function mdy(serno)
  {
     ...
     document.mform.action="onlineapplication101_mdy.jsp";
     document.mform.method="post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="onlineapplication101_del.jsp?type=0";
        document.mform.method="post";
        document.mform.submit();
     } 
  } 
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  <tr align="center">
    ...
    <th width="12%">顯示</th>
    <th width="18%" align="left">發布單位</th>
    <th width="15%">更新日期</th>
  </tr>
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	OnLineApplicationData qlist = ( OnLineApplicationData )qlists.get( i ); %>
