...
<!--
程式名稱：onlineapplication101_addsave.jsp
說明：線上申辦
開發者：chmei
開發日期：97.10.26
修改者：
...
<%
  ...
  OnLineApplicationData obj = new OnLineApplicationData();
...
<form name="mform" action="onlineapplication101_add.jsp" method="post">
