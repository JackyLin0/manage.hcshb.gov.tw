...
<!--
程式名稱：onlineapplication101_add.jsp
說明：線上申辦
開發者：chmei
開發日期：97.10.26
修改者：
...
<script>
  ...
  function save()
  {
     ...
     document.mform.action = "onlineapplication101_addsave.jsp";
     document.mform.method = "post";
     document.mform.submit();
  }    
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <tr class="tr">
    ...
    <td colspan="3">
      <textarea name="content" cols="75" rows="2"></textarea>
  ...
  <tr>
    ...
    <td colspan="3">
      <input name="relateurl" type="text" class="lInput01" value="http://" size="45" maxlength="150"/>&nbsp;
      <span class="T12b">請輸入網站名稱</span>&nbsp;<input name="relatename" type="text" class="lInput01" size="35" value="" maxlength="60"/>
    </td>
  </tr>
  <tr class="tr">
