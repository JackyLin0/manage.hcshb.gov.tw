...
<script>
  function add()
  {
    document.mform.action="questionnaire101_add.jsp";
  ...
  function qry()
  {
    document.mform.action="questionnaire101.jsp";
    document.mform.method="post";
    document.mform.submit();
  }  
  ...
  function mdy(serno)
  {
     ...
     document.mform.action="questionnaire101_mdy.jsp";
     document.mform.method="post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="questionnaire101_del.jsp?type=0";
        document.mform.method="post";
        document.mform.submit();
     } 
  } 
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	QuestionnaireData qlist = ( QuestionnaireData )qlists.get( i );
    	//查詢是否已填寫問卷
    	QuestionData qdata = new QuestionData();
    	ArrayList qdatas = qdata.findBydata(qlist.getSerno());
    	String mdisable = "";
    	if ( qdatas != null )
    		mdisable = "disabled"; %>
