...
<%
  ...
  InformationData970425 qmitem = new InformationData970425();
...
<script>
  ...
  function AddRow() 
  {
	  ...
	  {   
	     newrow.insertCell(i)
	     var data = k + "." + "標題：<input type=text name=item" + k + " size=45 maxlength=50><span class=T10>    (至多50個中文字）</span><br>";
	     data = data + "&nbsp;&nbsp;&nbsp;內容：<textarea name=content" + k + " cols=65 rows=7></textarea><br><span class=T10>    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(至多1000個中文字）</span>";
  ...
  function save()
  {
     ...
     document.mform.action = "information101_mdysave.jsp";
     document.mform.method = "post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="information101_del.jsp?type=1";
        document.mform.method="post";
        document.mform.submit();
     } 
  }           
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <tr class="tr">
    <td class="T12b" valign="top"><span class="T12red">※</span>項目</td>
    <td colspan="3">
                  ...
                  <%
                    if ( qitems != null ) {
                    	for ( int i=0; i<rcount; i++ ) {
                    		InformationData970425 qitem = ( InformationData970425 )qitems.get( i ); %>
                    		<%=i+1%>.標題：<input type=text name=item<%=i+1%> size="45" maxlength="50" value="<%=qitem.getItem()%>"/><span class=T10>    (至多50個中文字）</span><br>
                    		&nbsp;&nbsp;&nbsp;內容：<textarea name=content<%=i+1%> cols="65" rows="7"><%=qitem.getContent()%></textarea><br><span class=T10>    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(至多1000個中文字）</span><br>
                    	<%}
                    }%>
                </td>
              </tr>
  ...
  <tr>
    ...
    <td colspan="3">
      <input name="relateurl" type="text" class="lInput01" size="42" maxlength="120" value="<%=mrelaturl%>"/>&nbsp;
