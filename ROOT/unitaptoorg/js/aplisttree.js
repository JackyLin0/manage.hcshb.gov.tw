...
Ext.onReady(function() {
    ...
    var treepanel = new Tree.TreePanel({
        el : 'aplist',       //將樹放在一個指定的div中,需跟div之id對應
        //region : 'west',
        title : '應用系統樹',
        width : 190,
        minSize : 180,
    ...
    var rootnode = new Tree.AsyncTreeNode({    //宣告為AsyncTreeNode，才能達到非同步載入
    	...
    	expanded : true,     
    	//href : '../node_upd.jsp?apdn=ou=ap_root,o=hcshb,c=tw',
        //hrefTarget : 'center',
    ...
    treepanel.on('beforeload', function(node) {
    	treepanel.loader.dataUrl = 'aptree.jsp?parentId=' + node.id + "&websitedn=" + document.getElementById("websitedn").value;
    });
