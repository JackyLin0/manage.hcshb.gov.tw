...
<%
  ...
  IndexBannerData query = new IndexBannerData();  
...
<script>
  ...
  function save()
  {
     ...
     document.mform.action = "indexbanner101_mdysave.jsp";
  ...
  function del()
  {
     ...
     if(x)
     {
        ...
        document.backform.action="indexbanner101_del.jsp?type=1";
        document.backform.method="post";
        document.backform.submit();
     } 
  }           
    ...
    <td class="T12b">
      ...
      <%
        if ( oserverfile1 != null && !oserverfile1.equals("") ) {
        	...
        	<br><br><span class="T10">【原圖片檔名】：<a href="../../downdoc?file=/<%=java.net.URLEncoder.encode(query.getServerfile(),"UTF-8")%>&flag=indexbannerpath"><%=oclientfile1%></a></span><br>
        	<%
        	  if ( query.getImagemagick() != null && !query.getImagemagick().equals("null") && !query.getImagemagick().equals("") ) { %>
        		  <img src="../../downdoc?file=/<%=java.net.URLEncoder.encode(msfile,"UTF-8")%>&flag=indexbannerpath" alt="<%=query.getExpfile()%>" border="0"/></a>
    	      <%}else{%>
    	    	  <img src="../../showimage?file=/<%=java.net.URLEncoder.encode(msfile,"UTF-8")%>&flag=indexbannerpath&w=230&h=170" alt="<%=query.getExpfile()%>" border="0"/></a>
    	      <%}
        }%>
