...
<script>
  function add() {
    document.mform.action="indexbanner101_add.jsp";
    document.mform.method="post";
    document.mform.submit();
  }
  
  function qry() {
    document.mform.action="indexbanner101.jsp";
    document.mform.method="post";
    document.mform.submit();
  }  
  ...
  function mdy(serno) {
     ...
     document.mform.action="indexbanner101_mdy.jsp";
     document.mform.method="post";
     document.mform.submit();
  } 
  ...
  function del() {
     ...
     if(x) {
        document.mform.action="indexbanner101_del.jsp?type=0";
        document.mform.method="post";
        document.mform.submit();
     } 
  } 
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	IndexBannerData qlist = ( IndexBannerData )qlists.get( i ); %>
