...
<script>
  ...
  {  
     ...
     document.mform.action = "activityphoto101_addsave.jsp?webrcount="+rcount;
     document.mform.method = "post";
     document.mform.submit();
  }    
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <tr>
    ...
    <td colspan="3">
      <textarea name="sponsorunit" cols="76" rows="3"></textarea><br>
  ...
  <tr class="tr">
    ...
    <td colspan="3">
      <textarea name="assistunit" cols="76" rows="3"></textarea><br>
      <span class="T10">多個單位請以頓號(、)隔開&nbsp;&nbsp;&nbsp;(不可超過500個中文字）</span>
    </td>
  </tr> 
  <tr>
    ...
    <td colspan="3">
      <textarea name="content" cols="76" rows="18"></textarea>
  ...
  <tr class="tr">
    ...
    <td colspan="3">
      <input name="actplace" type="text" class="lInput01" size="70" maxlength="100" />
      <span class="T10">&nbsp;&nbsp;&nbsp;(不可超過100個中文字）</span>
    </td>
  </tr> 
  <tr>
  ...
  <tr>
    ...
    <td colspan="3">
      <input name="liaisonfax" type="text" class="lInput01" size="50" maxlength="20" />
      &nbsp;&nbsp;&nbsp;<span class="T10">(不可超過20個字）</span>
    </td>
  </tr> 
  <tr class="tr">
