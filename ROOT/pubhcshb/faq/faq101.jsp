...
<script>
   function add()
   {
      document.mform.action="faq101_add.jsp";
   ...
   function mdy(serno)
   {
      ...
      document.mform.action="faq101_mdy.jsp";
      document.mform.method="post";
      document.mform.submit();
   } 
   ...
   function del()
   {
      ...
      if(x)
      {
         document.mform.action="faq101_del.jsp?type=0";
         document.mform.method="post";
         document.mform.submit();
      } 
   }
...
<%
  ...
  FAQData query = new FAQData();  
  ArrayList qlists = query.findByday(table2,keyword,qpunit,"FAQPoster");    
...
<form name="mform">
  <!-- 應用系統名稱 -->
   ...
   <span class="T11b"><%=lang.getQuestion()%></span>
   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
     <tr align="center">
       <th width="5%">&nbsp;</th>
       <th width="5%">&nbsp;</th>
       <th width="40%" align="left"><%=lang.getQuestion()%></th>
       <th width="10%"><%=lang.getShow()%></th>
       <th width="15%" align="left"><%=lang.getPubunitname()%></th>
       <th width="15%"><%=lang.getUpdatedate()%></th>
     </tr>
     <%
       ...
       for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	   FAQData qlist = ( FAQData )qlists.get( i ); %>
