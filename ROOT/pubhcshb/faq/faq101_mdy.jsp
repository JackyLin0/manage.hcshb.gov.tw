...
<script>
  ...
  function save(rcount)
  {
     ...
     document.mform.action = "faq101_mdysave.jsp?webrcount="+rcount;
     document.mform.method = "post";
     document.mform.submit();
  }    
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="faq101_del.jsp?type=1";
        document.mform.method="post";
        document.mform.submit();
     } 
  }         
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <tr>
    ...
    <td colspan="3">
      <input name="subject" type="text" class="lInput01" size="70" value="<%=qfile.getSubject()%>" maxlength="100"/>
  ...
  <tr class="tr">
    ...
    %>
    <td colspan="3">
      <textarea name="content" cols="80" rows="10"><%=mcontent%></textarea>
      <br><span class="T10">(不可超過1500個中文字）</span>
    </td>
  </tr>
  <tr>
    <td class="T12b"><%=lang.getFsort()%></td>
    <td colspan="3"><input name="fsort" type="text" class="lInput01" size="10" value="<%=qfile.getFsort()%>" ONKEYPRESS="if ((event.keyCode < 47) || (event.keyCode > 57)) event.returnValue = false;" />
  ...
  <tr class="tr">
    ...
    <td colspan="3">
      <input name="liaisonper" type="text" class="lInput01" size="50" maxlength="20" value="<%=qfile.getLiaisonper()%>"/>
  ...
  <tr>
    ...
    <td colspan="3">
      <input name="liaisontel" type="text" class="lInput01" size="50" maxlength="20" value="<%=qfile.getLiaisontel()%>"/>
  ...
  <tr class="tr">
    ...
    <td colspan="3">
      <input name="liaisonemail" type="text" class="lInput01" size="50" maxlength="40" value="<%=qfile.getLiaisonemail()%>" />
