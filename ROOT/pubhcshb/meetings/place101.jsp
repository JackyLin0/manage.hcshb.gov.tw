...
<script>
  function add()
  {
    document.classform.action="place101_add.jsp";
  ...
  function mdy(serno)
  {
     ...
     document.classform.action="place101_mdy.jsp";
     document.classform.method="post";
     document.classform.submit();
  } 
  ...
  function clean()
  {
     ...
     document.classform.placename.value = "請輸入關鍵字";
  }     
  ...
  function del()
  {
     ...
     if(x)
     {
        document.classform.action="place101_del.jsp?type=0";
        document.classform.method="post";
        document.classform.submit();
     } 
  }  
  ...
  function visit()
  {
    document.classform.action="place101_visit.jsp";
    document.classform.method="post";
    document.classform.submit();
  }
</script>
...
<%
  ...
  if ( placename == null || placename.lastIndexOf("請輸入") != -1 )
	  placename = "";

  PlaceData query = new PlaceData();
  ArrayList<Object> qlists = query.findByday(table,"",placename);
...
<input type="hidden" name="scheduledate" value="20140826"/>

<div id="title">
  <h2><img src="../../img/addedit.png" width="48" height="48" align="middle"/><%=title%></h2>
</div>

<div ><span class="T11b">場地名稱&nbsp;</span>
 <input name="placename" type="text" class="lInput01" size="20" value="<%=(placename.equals("") ? "請輸入關鍵字" : placename)%>" onFocus="javascript: if (this.value=='請輸入關鍵字') this.value='';" onBlur="javascript: if(this.value=='') this.value='請輸入關鍵字';" />
  &nbsp;&nbsp;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  <tr align="center">
    <th width="5%">&nbsp;</th>
    <th width="5%">&nbsp;</th>
    <th width="32%" align="left">場地名稱</th>
  ...
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	PlaceData qlist = ( PlaceData )qlists.get( i ); %>
    	<tr onMouseOver="this.style.backgroundColor='#f4f4f4';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#ffffff';">
    	  ...
    	  <td align="left"><a href="javascript:mdy('<%=qlist.getSerno()%>')"><%=qlist.getPlacename() %></a></td>
