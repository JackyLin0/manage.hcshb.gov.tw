...
<script>
  ...
  function save()
  {
     ...
     document.classform.action = "place101_addsave.jsp";
     document.classform.method="post";
     document.classform.submit();
  }    
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <tr>
    ...
    <td colspan="3">
      <input name="placename" type="text" class="lInput01" size="50"/>
    </td>
  </tr>
  <tr>
    <td class="T12b" align="center">場地說明</td>
    <td colspan="3">
      <textarea name="placeexplain" cols="75" rows="3" ></textarea>
