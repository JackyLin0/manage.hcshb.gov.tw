...
<%
  ...
  String piclibrary = ( String )request.getParameter( "piclibrary" );
  String[] ary_piclibrary = SvString.split(piclibrary,"||");
  
  String logincn = ( String )session.getAttribute("logincn");
  
  PicLibraryFileData obj = new PicLibraryFileData();
  obj.setSerno(ary_piclibrary[0]);
  obj.setDetailno(Integer.parseInt(ary_piclibrary[1]));
  obj.setPostname(logincn);
  
  obj.create(table,dataserno);
