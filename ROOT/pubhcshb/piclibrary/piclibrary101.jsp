...
<script>
  function upload(){
     document.fileform.action = "piclibrary101_upload.jsp";
     document.fileform.method = "post";
     document.fileform.submit();
  }
  
  function mdy(serno,detailno){
     document.fileform.serno.value = serno;
     document.fileform.detailno.value = detailno;
     document.fileform.action = "piclibrary101_mdy.jsp";
     document.fileform.method = "post";
     document.fileform.submit();
  }
  ...
  function del()
  {
     ...
     if(x)
     {
        document.fileform.action="piclibrary101_del.jsp";
        document.fileform.method="post";
        document.fileform.submit();
     } 
  }      
...
<%
  ...
  ArrayList qfiles = qupload.findByday(table);
  ...
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	...
    	<tr onMouseOver="this.style.backgroundColor='#f4f4f4';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#ffffff';">
    	  ...
    	  <td align="left"><a href="javascript:mdy('<%=qfile.getSerno()%>','<%=qfile.getDetailno()%>')"><%=mexppic%></a></td>
    	</tr>
    	<tr>
    	  <td colspan="3">&nbsp;</td>
    	</tr>
