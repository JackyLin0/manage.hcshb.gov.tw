...
<script>
  function back()
  {
     document.backform.action="bannerright101.jsp";
  ...
  function save()
  {
     ...
     document.mform.action = "bannerright101_mdysave.jsp";
  ...
  function del()
  {
     ...
     if(x)
     {
        ...
        document.backform.action="bannerright101_del.jsp?type=1";
        document.backform.method="post";
        document.backform.submit();
     } 
  }           
    ...
    <td class="T12b">
      ...
      <%
        if ( oserverfile1 != null && !oserverfile1.equals("") ) {
        	...
        	<%
        	  if ( query.getImagemagick() != null && !query.getImagemagick().equals("null") && !query.getImagemagick().equals("") ) { %>
        		  <img src="../../downdoc?file=/<%=java.net.URLEncoder.encode(msfile,"UTF-8")%>&flag=bannerpath" alt="<%=query.getExpfile()%>" border="0"/></a>
    	      <%}else{%>
    	    	  <img src="../../showimage?file=/<%=java.net.URLEncoder.encode(msfile,"UTF-8")%>&flag=bannerpath&w=173&h=50" alt="<%=query.getExpfile()%>" border="0"/></a>
    	      <%}
        }%>
