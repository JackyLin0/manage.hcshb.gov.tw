...
<script>
  ...
  function save()
  {
     ...
     document.mform.action = "statistics101_mdysave.jsp";
     document.mform.method = "post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="statistics101_del.jsp?type=1";
        document.mform.method="post";
        document.mform.submit();
     } 
  }           
 ...
 <tr class="tr">
  ...
  <tr>
   ...
   <tr class="tr">
    ...
    <td colspan="3">
      <textarea name="content" cols="78" rows="12"><%=query.getContent()%></textarea>
