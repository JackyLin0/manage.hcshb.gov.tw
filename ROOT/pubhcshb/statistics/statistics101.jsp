...
<script>
  function add()
  {
    document.mform.action="statistics101_add.jsp";
  ...
  function mdy(serno)
  {
     ...
     document.mform.action="statistics101_mdy.jsp";
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="statistics101_del.jsp?type=0";
        document.mform.method="post";
        document.mform.submit();
     } 
  } 
...
<%
  ...
  StatisticsData query = new  StatisticsData();    
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  <tr align="center">
    <th width="4%">&nbsp;</th>
    <th width="4%">&nbsp;</th>
    <th width="34%" align="left">標題</th>
    <th width="9%">顯示</th>
    <th width="20%" align="left">發布單位</th>
    <th width="11%">更新日期</th>
    <th width="9%">文件檔案</th>
    <th width="9%">圖片檔案</th>
    <!-- <th width="10%">影音檔案</th> -->
  ...
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	StatisticsData qlist = ( StatisticsData )qlists.get( i ); %>
    	<tr onMouseOver="this.style.backgroundColor='#f4f4f4';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#ffffff';">
    	  ...
    	  <td align="center"><a href="javascript:file('<%=qlist.getSerno()%>','doc','StatisticsFile','<%=path%>','<%=language%>','<%=pagesize%>')"><img src="../../img/file.gif" alt="file" width="16" height="16" border="0" align="middle" /></a></td>
    	  <td align="center"><a href="javascript:file('<%=qlist.getSerno()%>','pic','StatisticsFile','<%=path%>','<%=language%>','<%=pagesize%>')"><img src="../../img/Cmd_Save.gif" alt="attachments" width="16" height="16" border="0" align="middle" /></a></td>
    	  <!-- <td align="center"><a href="javascript:file('<%=qlist.getSerno()%>','media','StatisticsFile','<%=path%>','<%=language%>','<%=pagesize%>')"><img src="../../img/media1.gif" alt="media" width="16" height="16" border="0" align="middle" /></a></td> -->
    	</tr> 
