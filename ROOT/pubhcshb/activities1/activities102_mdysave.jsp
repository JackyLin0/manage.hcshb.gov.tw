...
<!--
程式名稱：activities102_mdysave.jsp
說明：線上報名表欄位編輯
開發者：chmei
開發日期：97.12.04
修改者：
...
<%
  ...
  String sorcefield = "200812030001";
  String sorceserial = "1";
  String sorceisneed = "Y";
//   if ( chk != null ) {
...
//   }
  ...
  if ( chk != null ) {
	  for ( int i=0; i<chk.length; i++ ) {
		  ...
		  if(serial1.equals("2")) {
			  sorceserial += "||2||3"; 
			  sorcefield = sorcefield + "||" + chk[i] + "||200812030003";
			  String isneed1 = ( String )request.getParameter( "isneed" + chk[i] );
			  if ( isneed1 == null || isneed1.equals("null") || isneed1.equals("") )
     			  sorceisneed = sorceisneed + "||N||Y";
     		  else
     			  sorceisneed = sorceisneed + "||Y||Y";
		  } else {
             if(i==0 && Integer.parseInt(serial1)>=3) {
               sorcefield = sorcefield + "||200812030003||" + chk[i];
			   sorceserial = sorceserial + "||3||" + serial1;
			   String isneed1 = ( String )request.getParameter( "isneed" + chk[i] );
	     		  if ( isneed1 == null || isneed1.equals("null") || isneed1.equals("") )
	     			  sorceisneed = sorceisneed + "||Y||N";
	     		  else
	     			  sorceisneed = sorceisneed + "||Y||Y";
             } else {
            	 sorcefield = sorcefield + "||" + chk[i];
...
//   showAlert = "結果:" + sorceserial + "@" +sorceisneed + "**" + sorcefield;
