...
<%
  ...
  int rcount1 = 0;
  //下拉選單變動時，activityserno 才會變
  if ( msubject != null && !msubject.equals("null") && !msubject.equals("") ) {
	 
	  ActivityExcelData qmrecord = new ActivityExcelData();
	  // tw.com.sysview.dba.ActivityExcelData@a4bd64
	  //, tw.com.sysview.dba.ActivityExcelData@18dfeed
	  //, tw.com.sysview.dba.ActivityExcelData@15b7b6d, 
