...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <tr>
    ...
    <td colspan="3">
      <input type="radio" name="startusing" value="1" onclick="chg()" />一年有效&nbsp;&nbsp;&nbsp;
      <input type="radio" name="startusing" value="0" onclick="chg()" checked/>截止日期
    </td>
  </tr>
  ...
  <%
    	...
    	<input type="hidden" name="noteflag" value="N" />	
  <%
    } %>
  <tr class="tr">
