...
<script>
  ...
  {  
     ...
     document.mform.action = "weblink101_addsave.jsp?webrcount="+rcount;
     document.mform.method = "post";
     document.mform.submit();
  }    
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <tr class="tr">
    <td class="T12b" width="17%"><span class="T12red">※</span><%=lang.getStartusing()%></td>
    <td colspan="3">
  ...
  <tr class="tr">
    <td class="T12b"><span class="T12red">※</span><%=lang.getRelateurl()%></td>
    <td colspan="3">
