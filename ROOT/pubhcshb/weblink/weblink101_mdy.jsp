...
<%
  ...
  WeblinkData qbulletin = new WeblinkData();    
...
<script>
  ...
  {          
     ...
     document.mform.action = "weblink101_mdysave.jsp?webrcount="+rcount;
     document.mform.method = "post";
     document.mform.submit();
  }    
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="weblink101_del.jsp?type=1";
        document.mform.method="post";
        document.mform.submit();
     } 
  }         
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <tr class="tr">
    ...
    <td colspan="3"><input name="fsort" type="text" class="lInput01" size="10" maxlength="2" value="<%=qbulletin.getFsort()%>" ONKEYPRESS="if ((event.keyCode < 47) || (event.keyCode > 57)) event.returnValue = false;" />
      <input type="button" value="<%=lang.getQry() %>" onclick="qsort('Weblink','<%=logindn%>')" />
    </td>
  </tr>
  <tr>
