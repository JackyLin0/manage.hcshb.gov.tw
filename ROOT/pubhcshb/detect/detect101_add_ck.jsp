...
<script>
  ...
  {  
     ...
     document.mform.action = "detect101_addsave_ck.jsp?webrcount="+rcount;
     document.mform.method = "post";
     document.mform.submit();
  }    
</script> 
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <tr>
    ...
    <td colspan="3">
      <textarea id="content" name="content" cols="80" rows="18" ></textarea>
...
<ckfinder:setupCKEditor basePath="/manage.hcshb.gov.tw/ckfinder/" editor="content" /> 
<ckeditor:replace replace="content" basePath="/manage.hcshb.gov.tw/ckeditor/" />
