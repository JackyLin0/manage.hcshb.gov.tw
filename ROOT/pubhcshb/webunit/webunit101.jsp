...
<script>
  function add()
  {
    document.mform.action="webunit101_add.jsp";
  ...
  function mdy(serno)
  {
     ...
     document.mform.action="webunit101_mdy.jsp";
     document.mform.method="post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="webunit101_del.jsp?type=0";
        document.mform.method="post";
        document.mform.submit();
     } 
  } 
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  <tr align="center">
    <th width="5%">&nbsp;</th>
    <th width="5%">&nbsp;</th>
    <th width="25%" align="left">標題</th>
    <th width="15%" align="left">分類</th>
    <th width="10%">顯示</th>
    <th width="28%" align="left">網址</th>
    <th width="12%">更新日期</th>
  </tr>
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	WebUnitData qlist = ( WebUnitData )qlists.get( i ); %>
