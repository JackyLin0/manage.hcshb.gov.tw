...
<script>
  ...
  function save()
  {
     ...
     document.mform.action = "community101_mdysave.jsp";
     document.mform.method = "post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="community101_del.jsp?type=1";
        document.mform.method="post";
        document.mform.submit();
     } 
  }           
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <tr class="tr">
    <td class="T12b"><span class="T12red">※</span>名稱</td>
    <td colspan="3">
  ...
  <tr>
    <td valign="top" class="T12b">簡介</td>
    <td colspan="3">
