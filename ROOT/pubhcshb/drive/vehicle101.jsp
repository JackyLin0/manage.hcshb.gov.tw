...
<!-- 
Programming Name: 車輛維護 - 列表
Programming File: vehicle101.jsp
...
<script>
  function add()
  {
    document.mform.action="vehicle101_add.jsp";
  ...
  function mdy(serno)
  {
     ...
     document.mform.action="vehicle101_mdy.jsp";
     document.mform.method="post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="vehicle101_del.jsp?type=0";
        document.mform.method="post";
        document.mform.submit();
     } 
  } 
...
<%
  ...
  ArrayList qlists = query.findByData( table, keyword );  
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	VehicleData qlist = ( VehicleData )qlists.get( i ); %>
    	<tr onMouseOver="this.style.backgroundColor='#f4f4f4';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#ffffff';">
    	  ...
    	  <td align="center"><%=qlist.getFactory()%>&nbsp;</td>
    	  <td align="center"><%=qlist.getModel() %>&nbsp;</td>
    	  <td align="center"><a href="javascript:mdy('<%=qlist.getSerno()%>')"><%=qlist.getLicenseplate() %></a></td>
    	  <td align="center"><%=qlist.getCarcolor() %>&nbsp;</td>
    	  <td align="center"><%=qlist.getRide() %></td>
    	  <%
    	    String mupdate = "";
