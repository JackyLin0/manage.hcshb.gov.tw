...
<script>
  function add(mdate)
  {
	  ...
	  document.mform.action="car101_add.jsp";
  ...
  function mdy(serno)
  {
	  ...
	  document.mform.action="car101_mdy.jsp";
	  document.mform.method="post";
	  document.mform.submit();
  }
</script>
...
<%
  ...
  String mhref = "car101.jsp?t=" + table + "&language=" + language + "&year=" + currYear;
                	    	        	  ...
                	    	        	  for ( int i=0; i<num; i++ ) {
                	    	        		  ...
                	    	        		  <tr>
                	    	        		    <td align="left"> 
                	    	        		      ...
                	    	        		      <a href="javascript:mdy('<%=qlist.getSerno()%>')">
