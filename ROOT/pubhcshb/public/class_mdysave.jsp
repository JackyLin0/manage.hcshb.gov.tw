...
<%
  ...
  String websitename = ( String )request.getParameter( "websitename" );
  ...
  WebClassData obj = new WebClassData();  
  ...
  obj.setWebsitedn(websitedn);         //使用站台DN
  obj.setWebsitename(websitename);     //使用站台名稱
...
<form name="mform" action="class.jsp" method="post">
