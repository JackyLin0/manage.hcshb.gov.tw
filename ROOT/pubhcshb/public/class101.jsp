...
<script>
  function add()
  {
    document.mform.action="class101_add.jsp";
  ...
  function mdy(serno)
  {
     ...
     document.mform.action="class101_mdy.jsp";
     document.mform.method="post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="class101_del.jsp?type=0";
        document.mform.method="post";
        document.mform.submit();
     } 
  }      
...
<%
  ...
  ArrayList qlists = query.findByday(table,qpunit,qclassname);    
