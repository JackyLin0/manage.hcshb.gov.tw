...
<script>
  function add()
  {
    document.mform.action="class102_add.jsp";
  ...
  function mdy(serno)
  {
     ...
     document.mform.action="class102_mdy.jsp";
     document.mform.method="post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="class102_del.jsp?type=0";
        document.mform.method="post";
        document.mform.submit();
     } 
  }      
...
<%
  ...
  ArrayList<Object> qlists = query.findByday(table,qpunit,qclassname,websitedn);  
...
<div>
  ...
  <span class="T11b"><%=lang.getClassname()%>&nbsp;</span>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  <tr align="center">
    <th width="5%">&nbsp;</th>
    <th width="5%">&nbsp;</th>
    <th width="50%" align="left"><%=lang.getClassname()%></th>
    <th width="20%" align="left"><%=lang.getPubunitname()%></th>
    <th width="20%"><%=lang.getUpdatedate()%></th>
  </tr>
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	TopicClassData qlist = ( TopicClassData )qlists.get( i ); %>    	
