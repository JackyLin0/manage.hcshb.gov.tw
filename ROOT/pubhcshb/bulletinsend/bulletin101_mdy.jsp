...
<script>
  ...
  {          
     ...
     document.mform.action = "bulletin101_mdysave.jsp?webrcount="+rcount;
     document.mform.method = "post";
     document.mform.submit();
  }    
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="bulletin101_del.jsp?type=1";
        document.mform.method="post";
        document.mform.submit();
     } 
  }         
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <%
    ...
    <%}%>
  <tr>
   <td class="T12b"><span class="T12red"></span>是否發佈新聞稿</td>
   <td colspan="3">
   <% if(qbulletin.getNewsflag().equals("Y")) { %>
                  資料已發布至新聞稿
   <% } else { %>
     <input type="radio" name="newsflag" value="Y" <%=(qbulletin.getNewsflag().equals("Y") ? "checked" : "")%> />是&nbsp;&nbsp;
     <input type="radio" name="newsflag" value="N" <%=(qbulletin.getNewsflag().equals("N") ? "checked" : "")%> />否
   <% } %>
   </td>
  </tr>
  <tr>
