...
<script>
  function add()
  {
    document.mform.action="bulletinsend101_add.jsp";
  ...
  function mdy(serno)
  {
     ...
     document.mform.action="bulletinsend101_mdy.jsp";
     document.mform.method="post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="bulletinsend101_del.jsp?type=0";
        document.mform.method="post";
        document.mform.submit();
     } 
  } 
...
<a class="md" href="javascript:report()">統計報表</a>
<%
  ...
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	...
    	<tr onMouseOver="this.style.backgroundColor='#f4f4f4';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#ffffff';">
    	  ...
    	  <td align="center"><a href="javascript:file('<%=qlist.getSerno()%>','doc','BulletinsendFile','<%=path%>','<%=language%>','<%=pagesize%>')"><img src="../../img/file.gif" alt="上傳附件" width="16" height="16" border="0" align="middle" /></a></td>
    	  <td align="center"><a href="javascript:file('<%=qlist.getSerno()%>','pic','BulletinsendFile','<%=path%>','<%=language%>','<%=pagesize%>')"><img src="../../img/Cmd_Save.gif" alt="上傳圖片" width="16" height="16" border="0" align="middle" /></a></td>
<%--     	  <td align="center"><a href="javascript:file('<%=qlist.getSerno()%>','media','BulletinsendFile','<%=path%>','<%=language%>','<%=pagesize%>')"><img src="../../img/media1.gif" alt="media" width="16" height="16" border="0" align="middle" /></a></td> --%>
    	</tr> 
    <%}%>
