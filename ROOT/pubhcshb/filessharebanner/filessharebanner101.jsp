...
<script>
  function add()
  {
    document.mform.action="filessharebanner101_add.jsp";
  ...
  function qry()
  {
    document.mform.action="filessharebanner101.jsp";
    document.mform.method="post";
    document.mform.submit();
  }  
  ...
  function mdy(serno)
  {
     ...
     document.mform.action="filessharebanner101_mdy.jsp";
     document.mform.method="post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="filessharebanner101_del.jsp?type=0";
        document.mform.method="post";
        document.mform.submit();
     } 
  } 
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	...
    	// 暫時先使用別的 DAO，因為伺服器要重新開啟才能讀取新增的 JavaBean 或 DAO Object， 以後再另做處理 2017.03.07 (Leo 紀錄)
    	//FilesShareBannerData qlist = ( FilesShareBannerData )qlists.get( i );
