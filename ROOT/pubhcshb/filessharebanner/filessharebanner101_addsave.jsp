...
<!--
程式名稱：filessharebanner101_addsave.jsp
說明：右側檔案分享管理
開發者：Leo Zeng
開發日期：2017.03.03
修改者：
...
<%
  ...
  { 
     ...
     response.sendRedirect("filessharebanner101.jsp");
     return;
  }
...
<form name="mform" action="filessharebanner101_add.jsp" method="post">
