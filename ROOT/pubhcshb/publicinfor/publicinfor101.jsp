...
<script>
  function add()
  {
    document.mform.action="publicinfor101_add.jsp";
  ...
  function qry()
  {
    document.mform.action="publicinfor101.jsp";
    document.mform.method="post";
    document.mform.submit();
  }  
  ...
  function mdy(serno)
  {
     ...
     document.mform.action="publicinfor101_mdy.jsp";
     document.mform.method="post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="publicinfor101_del.jsp?type=0";
        document.mform.method="post";
        document.mform.submit();
     } 
  } 
...
<%
  ...
  ArrayList<Object> qlists = query.findByday(table,keyword,websitedn,qclass,sdate1,sdate2);
...
<div>
  ...
  <input name="keyword" type="text" size="15" value="<%=(keyword.equals("") ? "請輸入關鍵字" : keyword)%>" onFocus="javascript: if (this.value=='請輸入關鍵字') this.value='';" onBlur="javascript: if(this.value=='') this.value='請輸入關鍵字';">
  <br><span class="T11b">分類</span>
  ...
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	...
    	<tr onMouseOver="this.style.backgroundColor='#f4f4f4';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#ffffff';">
    	  ...
    	  <td align="left"><input type="checkbox" name="check" value="<%=qlist.getSerno()%>"></td>
    	  <td align="left">
    	    <%
    	      String mflag = "";
    	      if ( qlist.getFlag().equals("1") ) {
    	    	  mflag = "連結外部網址";    	    	  
    	      }else if ( qlist.getFlag().equals("2") ) {
    	    	  mflag = "連結本網站功能";
    	      }else if ( qlist.getFlag().equals("3") ) {
    	    	  mflag = "開啟檔案";
    	      }else if ( qlist.getFlag().equals("4") ) {
    	    	  mflag = "文章型";
    	      }%>
    	    <%=mflag%>
    	  </td>
