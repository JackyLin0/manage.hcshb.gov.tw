...
<script>
  function add()
  {
    document.mform.action="bigbanner101_add.jsp";
  ...
  function qry()
  {
    document.mform.action="bigbanner101.jsp";
    document.mform.method="post";
    document.mform.submit();
  }  
  ...
  function mdy(serno)
  {
     ...
     document.mform.action="bigbanner101_mdy.jsp";
     document.mform.method="post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="bigbanner101_del.jsp?type=0";
        document.mform.method="post";
        document.mform.submit();
     } 
  } 
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	BigBannerData qlist = ( BigBannerData )qlists.get( i ); %>
