...
<script>
  function back()
  {
     document.backform.action="bigbanner101.jsp";
  ...
  function save()
  {
     ...
     document.mform.action = "bigbanner101_mdysave.jsp";
  ...
  function del()
  {
     ...
     if(x)
     {
        ...
        document.backform.action="bigbanner101_del.jsp?type=1";
        document.backform.method="post";
        document.backform.submit();
     } 
  }           
...
<%
  ...
  BigBannerData query = new BigBannerData();  
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  %>
  <tr class="tr">
    <td class="T12b"><span class="T12red">※</span>圖片上傳</td>
    <td class="T12b">
      ...
      <%
        if ( oserverfile1 != null && !oserverfile1.equals("") ) {
        	...
        	<br><br><span class="T10">【原圖片檔名】：<a href="../../downdoc?file=/<%=java.net.URLEncoder.encode(query.getServerfile(),"UTF-8")%>&flag=bannerpath"><%=oclientfile1%></a></span><br>
        	<%
        	  if ( query.getImagemagick() != null && !query.getImagemagick().equals("null") && !query.getImagemagick().equals("") ) { %>
        		  <img src="../../downdoc?file=/<%=java.net.URLEncoder.encode(msfile,"UTF-8")%>&flag=bannerpath" alt="<%=query.getExpfile()%>" border="0"/>
    	      <%}else{%>
    	    	  <img src="../../showimage?file=/<%=java.net.URLEncoder.encode(msfile,"UTF-8")%>&flag=bannerpath&w=173&h=50" alt="<%=query.getExpfile()%>" border="0"/>
    	      <%}
        }%>
        ...
        <br><span class="T10">【建議圖片尺寸560*105】</span>
    </td>
    <input type="hidden" name="nsfile1"/>
  </tr>  
  <tr>
    <td class="T12b"><span class="T12red">※</span>圖片說明</td>
    <td class="T12b">
  ...
  <tr>
    ...
    <td colspan="3">
      <input name="relateurl" type="text" class="lInput01" value="<%=query.getRelateurl()%>" size="50" maxlength="120" />&nbsp;
