...
<script>
  function add()
  {
    document.mform.action="bannerright101_add.jsp";
  ...
  function qry()
  {
    document.mform.action="bannerright101.jsp";
    document.mform.method="post";
    document.mform.submit();
  }  
  ...
  function mdy(serno)
  {
     ...
     document.mform.action="bannerright101_mdy.jsp";
     document.mform.method="post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="bannerright101_del.jsp?type=0";
        document.mform.method="post";
        document.mform.submit();
     } 
  } 
...
<%
  ...
  ArrayList qlists = query.findByday(table,keyword,websitedn,sdate1,sdate2);    
...
<div>
  ...
  <br><span class="T11b">發布日期</span>
   <jsp:include page="../../pubprogram/bdate.jsp" >
       <jsp:param name="sdatevalue" value="<%=java.net.URLEncoder.encode(qptdate,"UTF-8")%>" />
       <jsp:param name="edatevalue" value="<%=java.net.URLEncoder.encode(qdldate,"UTF-8")%>" />
   </jsp:include>  
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	BannerRightData qlist = ( BannerRightData )qlists.get( i ); %>
