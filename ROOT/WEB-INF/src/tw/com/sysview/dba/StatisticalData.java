...
public class StatisticalData extends WebSiteLog {
    ...
    public boolean create()
    {
    	...
    	try
    	{
    		...
    		String sql =  "insert into " + tablename;
    		       sql += "(Serno,PubUnitDN,PubUnitName,Mserno,Mclassname,WebSiteDN,WebSiteName,Subject,SecSubject,Content,PosterDate,CloseDate,StartUsing,RelateUrl,RelateName,Fsort,PostName,CreateDate,UpdateDate)";
    		       sql += " values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    		...
    		stmts2.setString(6, websitedn );
    		stmts2.setString(7, websitename );
    		stmts2.setString(8, subject );
    		stmts2.setString(9, secsubject );
    		stmts2.setString(10, content );
	...
	//查詢多筆資料及筆數
    public ArrayList<Object> findByday( String tablename, String keyword, String punit, String qclass, String sdate1, String sdate2, String websitedn )
    {
    	Connection conn = null;
    	try
    	{
    	...
    	try
    	{
    		...
    		sSql.append( " and PosterDate >= '" + sdate1 + "' and PosterDate <= '" + sdate2 + "' and WebSiteDN = '" + websitedn + "'" );
    		...
    		{
    			StatisticalData tmpQuery = new StatisticalData();
