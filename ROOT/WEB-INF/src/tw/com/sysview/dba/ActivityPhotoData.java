...
public class ActivityPhotoData extends WebSiteLog {
    ...
    public boolean create()
    {
    	...
    	try
    	{
    		...
    		String sql =  "insert into " + ary_aptable[1];
    		       ...
    		       sql += ",LiaisonPer,LiaisonTel,LiaisonFax,LiaisonEmail,OnLineSign,IsLimitNum,LimitNum,SignUpNum,PosterDate,CloseDate,StartUsing,RelateUrl,RelateName,Fsort,PostName,CreateDate,UpdateDate)";
    		       sql += " values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    		...
    		stmts2.setString(20, limitnum );
    		stmts2.setString(21, signupnum );
    		stmts2.setString(22, posterdate );
    		stmts2.setString(23, closedate );
    		stmts2.setString(24, startusing );
    		stmts2.setString(25, relateurl );
    		stmts2.setString(26, relatename );
    		stmts2.setInt(27, fsort );
    		stmts2.setString(28, postname );
    		stmts2.setString(29, getNowYear() );
    ...
    public ArrayList<Object> findByday( String tablename, String keyword, String punit, String sdate1, String sdate2, String tablename1, String subwebsitedn )
    {
    	...
    	try
    	{
    		...
    		{
    			ActivityPhotoData tmpQuery = new ActivityPhotoData();
    			...
    			tmpQuery.setLimitnum( rs.getString( "LimitNum" ) );
    			tmpQuery.setSignupnum( rs.getString( "SignUpNum" ) );
    ...
    public boolean load( String tablename , String serno )
    {
    	...
    	try
    	{
    		...
    		this.limitnum = rs.getString( "LimitNum" );
    		this.signupnum = rs.getString( "SignUpNum" );
    ...
    public boolean store()
    {
    	...
    	try
    	{
    		...
    		stmts2 = conn.prepareStatement(
    			...
    			"ActPlace = ?, LiaisonPer = ?, LiaisonTel = ?, LiaisonFax = ?, LiaisonEmail = ?, PosterDate = ?, CloseDate = ?, StartUsing = ?, RelateUrl = ?, RelateName = ?, Fsort = ?, PostName = ?, UpdateDate = ? where Serno = ? and PubUnitDN = ?");
    		stmts2.clearParameters();    	 	
    		...
    		stmts2.setString(23, serno );
    		stmts2.setString(24, pubunitdn );
