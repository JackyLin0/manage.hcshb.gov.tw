...
public class CommercialData extends WebSiteLog {
    ...
    public boolean create()
    {
    	...
    	try
    	{
    		...
    		String sql =  "insert into " + tablename;
    		       sql += "(Serno,PubUnitDN,PubUnitName,Mserno,Mclassname,Subject,Content,PosterDate,CloseDate,StartUsing,Area,CityNo,TownsNo,Address,RelateUrl,RelateName,Fsort,LiaisonPer,LiaisonTel,LiaisonEmail,PostName,CreateDate,UpdateDate)";
    		       sql += " values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    		...
    		stmts2.setString(11, area );
    		stmts2.setString(12, cityno );
    		stmts2.setString(13, townsno );
    		stmts2.setString(14, address );
    ...
    public ArrayList<Object> findByday( String tablename, String keyword, String punit, String qclass )
    {
    	...
    	try
    	{
    		...
    		{
    			CommercialData tmpQuery = new CommercialData();
    ...
    public boolean store()
    {
    	...
    	try
    	{
    		...
    		stmts2 = conn.prepareStatement(
    			"update " + tablename + " set Mserno = ?, Mclassname = ?, Subject = ?, Content = ?, PosterDate = ?, CloseDate = ?, StartUsing = ?, Area = ?, CityNo = ?, TownsNo = ?, Address = ?, RelateUrl = ?, RelateName = ?, Fsort = ?, LiaisonPer = ?, LiaisonTel = ?, LiaisonEmail = ?, PostName = ?, UpdateDate = ? where Serno = ? and PubUnitDN = ?");
