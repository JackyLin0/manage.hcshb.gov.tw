...
public class LawTaskData extends WebSiteLog {
    ...
    public boolean create()
    {
    	...
    	try
    	{
    		...
    		String sql =  "insert into " + ary_aptable[1];
    		       sql += "(Serno,PubUnitDN,PubUnitName,Subject,Content,PosterDate,CloseDate,StartUsing,RelateUrl,RelateName,Fsort,PostName,CreateDate,UpdateDate)";
    		       sql += " values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public ArrayList<Object> findByday( String tablename, String keyword, String punit, String sdate1, String sdate2, String tablename1 )
    {
    	...
    	try
    	{
    		...
    		{
    			LawTaskData tmpQuery = new LawTaskData();
    ...
    public boolean store()
    {
    	...
    	try
    	{
    		...
    		stmts2 = conn.prepareStatement(
    			"update " + ary_aptable[1] + " set Subject = ?, Content = ?, PosterDate = ?, CloseDate = ?, StartUsing = ?, " + 
