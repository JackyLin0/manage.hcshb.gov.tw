...
public class MedResourcesData extends WebSiteLog {
    ...
    public boolean create()
    {
    	...
    	try
    	{
    		...
    		String sql =  "insert into " + tablename;
    		       sql += "(Serno,PubUnitDN,PubUnitName,Subject,Content,Area,CityNo,CityName,TownsNo,TownsName,Address,PosterDate,CloseDate,StartUsing,RelateUrl,RelateName,Fsort,LiaisonPer,LiaisonTel,LiaisonEmail,PostName,CreateDate,UpdateDate)";
    		       sql += " values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    		...
    		stmts2.setString(8, cityname );
    		stmts2.setString(9, townsno );
    		stmts2.setString(10, townsname );
    		stmts2.setString(11, address );
    		stmts2.setString(12, posterdate );
    		stmts2.setString(13, closedate );
    		stmts2.setString(14, startusing );
    		stmts2.setString(15, relateurl );
    		stmts2.setString(16, relatename );
    		stmts2.setInt(17, fsort );
    ...
    public ArrayList<Object> findByday( String tablename, String keyword, String punit )
    {
    	...
    	try
    	{
    		...
    		{
    			MedResourcesData tmpQuery = new MedResourcesData();
    ...
    public boolean store()
    {
    	...
    	try
    	{
    		...
    		stmts2 = conn.prepareStatement(
    			"update " + tablename + " set Subject = ?, Content = ?, Area = ?, CityNo = ?, CityName = ?, TownsNo = ?, TownsName = ?, Address = ?, PosterDate = ?, CloseDate = ?, StartUsing = ?, RelateUrl = ?, RelateName = ?, Fsort = ?, LiaisonPer = ?, LiaisonTel = ?, LiaisonEmail = ?, PostName = ?, UpdateDate = ? where Serno = ? and PubUnitDN = ?");
    		   		
    		stmts2.setString(1, subject );
    		stmts2.setString(2, content );
    		stmts2.setString(3, area );
    		stmts2.setString(4, cityno );
    		stmts2.setString(5, cityname );
    		stmts2.setString(6, townsno );
    		stmts2.setString(7, townsname );
    		stmts2.setString(8, address );
