...
public class TalkHealthData extends WebSiteLog {
    ...
    public boolean create()
    {
    	...
    	try
    	{
    		...
    		String sql =  "insert into " + tablename;
    		       sql += "(Serno,PubUnitDN,PubUnitName,Subject,SecSubject,Content,PosterDate,CloseDate,StartUsing,RelateUrl,RelateName,Author,Publisher,Flag,Fsort,PostName,CreateDate,UpdateDate)";
    		       sql += " values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    		...
    		stmts2.setString(12, author );
    		stmts2.setString(13, publisher );
    		stmts2.setString(14, "N" );
    ...
    public ArrayList<Object> findByday( String tablename, String keyword, String punit )
    {
    	...
    	try
    	{
    		...
    		{
    			TalkHealthData tmpQuery = new TalkHealthData();
    ...
    public boolean store()
    {
    	...
    	try
    	{
    		...
    		stmts2 = conn.prepareStatement(
    			"update " + tablename + " set Subject = ?, SecSubject = ?, Content = ?, PosterDate = ?, CloseDate = ?, StartUsing = ?, RelateUrl = ?, RelateName = ?, Author = ?, Publisher = ?, Fsort = ?, PostName = ?, UpdateDate = ? where Serno = ? and PubUnitDN = ?");
    		...
    		stmts2.setString(9, author );
    		stmts2.setString(10, publisher );
