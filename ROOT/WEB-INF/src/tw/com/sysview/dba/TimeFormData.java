...
public class TimeFormData extends WebSiteLog {
    ...
    public boolean create()
    {
    	...
    	try
    	{
    		...
    		String sql =  "insert into " + tablename;
    		       sql += "(Serno,PubUnitDN,PubUnitName,Subject,SecSubject,Content,PosterDate,CloseDate,StartUsing,Fsort,Flag,LiaisonPer,LiaisonTel,LiaisonEmail,PostName,CreateDate,UpdateDate)";
    		       sql += " values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    		...
    		stmts2.setString(11, flag );
    		stmts2.setString(12, liaisonper );
    		stmts2.setString(13, liaisontel );
    ...
    public ArrayList<Object> findByday( String tablename, String keyword, String punit )
    {
    	...
    	try
    	{
    		...
    		{
    			TimeFormData tmpQuery = new TimeFormData();
    ...
    public boolean store()
    {
    	...
    	try
    	{
    		...
    		stmts2 = conn.prepareStatement(
    			"update " + tablename + " set Subject = ?, SecSubject = ?, Content = ?, PosterDate = ?, CloseDate = ?, StartUsing = ?, Fsort = ?, Flag = ?, LiaisonPer = ?, LiaisonTel = ?, LiaisonEmail = ?, PostName = ?, UpdateDate = ? where Serno = ? and PubUnitDN = ?");
    		...
    		stmts2.setString(8, flag );
    		stmts2.setString(9, liaisonper );
    		stmts2.setString(10, liaisontel );
    		stmts2.setString(11, liaisonemail );
