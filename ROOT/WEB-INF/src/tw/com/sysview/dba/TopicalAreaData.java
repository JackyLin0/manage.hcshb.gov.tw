...
public class TopicalAreaData extends WebSiteLog {
    ...
    public boolean create()
    {
    	...
    	try
    	{
    		...
    		String sql =  "insert into " + tablename;
    		       sql += "(Serno,PubUnitDN,PubUnitName,Subject,PosterDate,CloseDate,StartUsing,RelateUrl,RelateName,ClientFile,ServerFile,ExpFile,ImageMagick,Fsort,PostName,CreateDate,UpdateDate)";
    		       sql += " values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    		...
    		stmts2.setString(10, clientfile );
    		stmts2.setString(11, serverfile );
    		stmts2.setString(12, expfile );
    		stmts2.setString(13, imagemagick );
	...
	//查詢多筆資料及筆數
    public ArrayList<Object> findByday( String tablename, String keyword, String sdate1, String sdate2 )
    {
    	Connection conn = null;
    	try
    	{
    	...
    	try
    	{
    		...
    		{
    			TopicalAreaData tmpQuery = new TopicalAreaData();
