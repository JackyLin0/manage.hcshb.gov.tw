...
public class FAQData extends WebSiteLog {
    ...
    public boolean create()
    {
    	...
    	try
    	{
    		...
    		String sql =  "insert into " + ary_aptable[1];
    		       sql += "(Serno,PubUnitDN,PubUnitName,Subject,Content,CloseDate,StartUsing,Fsort,LiaisonPer,LiaisonTel,LiaisonEmail,PostName,CreateDate,UpdateDate)";
    		       sql += " values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public boolean store()
    {
    	...
    	try
    	{
    		...
    		stmts2 = conn.prepareStatement(
    			"update " + ary_aptable[1] + " set Subject = ?, Content = ?, CloseDate = ?, StartUsing = ?, Fsort = ?, LiaisonPer = ?, LiaisonTel = ?, LiaisonEmail = ?, PostName = ?, UpdateDate = ? where Serno = ? and PubUnitDN = ?");
    		...
    		stmts2.setString(6, liaisonper );
    		stmts2.setString(7, liaisontel );
    		stmts2.setString(8, liaisonemail );
