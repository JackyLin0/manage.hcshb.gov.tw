...
public class VolunteerData extends WebSiteLog {
	...
	//查詢多筆資料及筆數
    public ArrayList<Object> findByday( String tablename, String keyword, String punit, String qclass, String sdate1, String sdate2 )
    {
    	Connection conn = null;
    	try
    	{
    	...
    	try
    	{
    		...
    		{
    			VolunteerData tmpQuery = new VolunteerData();
