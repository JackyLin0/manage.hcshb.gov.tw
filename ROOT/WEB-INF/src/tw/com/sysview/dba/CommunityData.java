...
public class CommunityData extends WebSiteLog {
    ...
    public boolean create()
    {
    	...
    	try
    	{
    		...
    		String sql =  "insert into " + tablename;
    		       sql += "(Serno,PubUnitDN,PubUnitName,Mserno,Mclassname,Subject,Content,Area,CityNo,CityName,TownsNo,TownsName,Address,PosterDate,CloseDate,StartUsing,RelateUrl,RelateName,Fsort,LiaisonPer,LiaisonTel,LiaisonEmail,PostName,CreateDate,UpdateDate)";
    		       sql += " values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    		...
    		stmts2.setString(7, content );
    		stmts2.setString(8, area );
    		stmts2.setString(9, cityno );
    		stmts2.setString(10, cityname );
    		stmts2.setString(11, townsno );
    		stmts2.setString(12, townsname );
    		stmts2.setString(13, address );
    		stmts2.setString(14, posterdate );
    		stmts2.setString(15, closedate );
    		stmts2.setString(16, startusing );
    		stmts2.setString(17, relateurl );
    		stmts2.setString(18, relatename );
    		stmts2.setInt(19, fsort );
    		stmts2.setString(20, liaisonper );
    		stmts2.setString(21, liaisontel );
    		stmts2.setString(22, liaisonemail );
    		stmts2.setString(23, postname );
    		stmts2.setString(24, getNowYear() );
    		stmts2.setString(25, getNowYear() );
    ...
    public ArrayList<Object> findByday( String tablename, String keyword, String punit, String qclass )
    {
    	...
    	try
    	{
    		...
    		{
    			CommunityData tmpQuery = new CommunityData();
    			...
    			tmpQuery.setTownsname( rs.getString( "TownsNo" ) );
    ...
    public boolean store()
    {
    	...
    	try
    	{
    		...
    		stmts2 = conn.prepareStatement(
    			"update " + tablename + " set Mserno = ?, Mclassname = ?, Subject = ?, Content = ?, Area = ?, CityNo = ?, CityName = ?, TownsNo = ?, TownsName = ?, Address = ?, PosterDate = ?, CloseDate = ?, StartUsing = ?, RelateUrl = ?, RelateName = ?, Fsort = ?, LiaisonPer = ?, LiaisonTel = ?, LiaisonEmail = ?, PostName = ?, UpdateDate = ? where Serno = ? and PubUnitDN = ?");
    		   		
    		stmts2.setString(1, mserno );
    		stmts2.setString(2, mclassname );
    		stmts2.setString(3, subject );
    		stmts2.setString(4, content );
    		stmts2.setString(5, area );
    		stmts2.setString(6, cityno );
    		stmts2.setString(7, cityname );
    		stmts2.setString(8, townsno );
    		stmts2.setString(9, townsname );
    		stmts2.setString(10, address );
    		stmts2.setString(11, posterdate );
    		stmts2.setString(12, closedate );
    		stmts2.setString(13, startusing );
    		stmts2.setString(14, relateurl );
    		stmts2.setString(15, relatename );
    		stmts2.setInt(16, fsort );
    		stmts2.setString(17, liaisonper );
    		stmts2.setString(18, liaisontel );
    		stmts2.setString(19, liaisonemail );
    		stmts2.setString(20, postname );
    		stmts2.setString(21, getNowYear() );
    		stmts2.setString(22, serno );
    		stmts2.setString(23, pubunitdn );
