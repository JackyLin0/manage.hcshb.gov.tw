...
public class ClassData extends WebSiteLog {
	...
	//查詢多筆資料及筆數
    public ArrayList<Object> findByday( String tablename, String punit, String classname )
    {
    	Connection conn = null;
    	try
    	{
    	...
    	try
    	{
    		...
    		{
    			ClassData tmpQuery = new ClassData();
    ...
    public boolean store()
    {
    	...
    	try
    	{
    		...
    		stmts = conn.prepareStatement(
    				"update " + tablename + " set ClassName = ?, UpdateDate = ? where Serno = ? and PubUnitDN = ?" ); 
    		stmts.clearParameters();    	 	
    ...
    public ArrayList<Object> findByday( String tablename )
    {
    	...
    	try
    	{
    		...
    		sSql.append( "select * from " + tablename + " order by PubUnitDN,Serno" );
