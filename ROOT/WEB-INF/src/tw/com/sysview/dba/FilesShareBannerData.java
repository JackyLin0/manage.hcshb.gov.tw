/*
 * ?í∞ÂØ´Êó•??üÔ??2008/2/23
 * Á®ãÂ?èÂ?çÁ®±ÔºöBannerRightData.java
 * ??üËÉΩÔº?
 * ?í∞ÂØ´Ë?ÖÔ?öÂºµË≥áÊ??
 */
...
public class FilesShareBannerData extends WebSiteLog {
    ...
    public boolean create()
    {
    	...
    	try
    	{
    		...
    		//Á∂≤Á?ôÁ∂≠??ãÁµ±Ë®àÂÖ±?î®??ÉÊï∏(WebSiteLog)
    ...
    public ArrayList<Object> findByday( String tablename, String keyword, String websitedn, String sdate1, String sdate2 )
    {
    	...
    	try
    	{
    		...
    		{
    			FilesShareBannerData tmpQuery = new FilesShareBannerData();
