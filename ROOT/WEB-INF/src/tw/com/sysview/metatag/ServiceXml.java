...
public class ServiceXml {
    ...
    public boolean createfile( String path )
    {
    	try
    	{
    		...
    		ArrayList<Object> qlists1 = query1.findByone("MetaTagClass1", "3", "Y");    		
    		...
    		mw.write("<tree id='0'>");
    		mw.write("<item text='服務分類' id='服務分類' open='1' im0='folderOpen.gif' im1='folderOpen.gif' im2='folderOpen.gif' call='1' select='1'>");
    		//第一層
    		if ( qlists1 != null ) {
    			for ( int i=0; i<rcount1; i++ ) {
    	    		...
    	    		ArrayList<Object> qlists2 = query2.findBytwo("MetaTagClass2", "3", qlist1.getClassno1(), "Y");
    	    		...
    	    		if ( qlists2 != null ) {
    	    			for ( int j=0; j<rcount2; j++ ) {
    	    	    		...
    	    	    		ArrayList<Object> qlists3 = query3.findBythree("MetaTagClass3", "3", qlist1.getClassno1(), qlist2.getClassno2(), "Y");
