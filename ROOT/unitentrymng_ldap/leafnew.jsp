...
<script>
  function save()
  {
    ...
    document.mform.action="leafadd.jsp";
...
<%     
  ...
  boolean qdata = qou.query( dn, "dn,chinesetitle,objectclass,ou,cn", "objectclass=department", SvLdap.QUERYBASE );
   ...
   <%
     if ( qdata ) {
    	 while ( qou.next() ) { 
    		 ...
    		 <tr>
    		   <th colspan="4"><%=ctitle%>--新增成員</th>
    		 </tr>
    		 <tr class="tr">
    		   <td class="T12b"><span class="T12red">※</span>使用者帳號&nbsp;</td>
    		   <td colspan="3">
    		     <input name="uid" type="text" class="lInput01" size="20">
    		   </td>
    		 </tr>
    		 <tr>
    		   <td class="T12b" width="25%"><span class="T12red">※</span>姓　　　名&nbsp;</td>
    		   <td colspan="3">
    		     <input name="cn" type="text" class="lInput01" size="15">
    		   </td>
    		 </tr>
    		 <tr class="tr">
    		   <td class="T12b">身分證字號</td>
    		   <td colspan="3">
    		     <input name="carlicense" type="text" class="lInput01" size="20">
    		   </td>
    		 </tr>
    		 <tr>
    		   <td class="T12b">E-mail</td>
    		   <td colspan="3">
    		     <input name="email" type="text" class="lInput01" size="30">
    		   </td>
    		 </tr>
    	 <%}%>
    	 <tr class="tr">
