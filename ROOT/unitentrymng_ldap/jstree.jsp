...
<%
  ...
  boolean qdata = qou.query( pubunitdn, "dn,chinesetitle,objectclass,ou", SvLdap.QUERYBASE );
  String unitname = "";
  if ( qdata ) {
	  while (qou.next()) {
		  unitname = qou.getString("chinesetitle");
	  }
  }
...
<script>
	...
	var FirstURL = "toptree.jsp?Level=1&sdn=<%=pubunitdn%>"		            <!---Top Level URL--->
	...
	var strFirstLine = "<tr><td colspan=50><img src='image/org.gif'><font fontface='細明體' size=2><a href='node.jsp?dn=<%=pubunitdn%>' target='right'><%=unitname%></</font></td></tr>"
	var objOpenWin = top
	<!---系統變數--->
