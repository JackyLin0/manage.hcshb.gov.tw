...
/*    if ( document.mform.liaisonemail.value != '' )
     ...
     document.mform.action = "teach101_mdysave.jsp";
     document.mform.method = "post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="teach101_del.jsp?type=1";
        document.mform.method="post";
        document.mform.submit();
     } 
  }           
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <tr class="tr">
    ...
    <td colspan="3">
      <input name="secsubject" type="text" class="lInput01" size="50" maxlength="100" value="<%=query.getSecsubject()%>"/>
  ...
  <tr>
    <td valign="top" class="T12b">教材簡介</td>
