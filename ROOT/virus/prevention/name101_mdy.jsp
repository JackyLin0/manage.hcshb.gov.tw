...
<script>
  ...
  function save()
  {
     ...
     document.mform.action = "name101_mdysave.jsp";
     document.mform.method = "post";
     document.mform.submit();
  } 
  ...
  function del()
  {
     ...
     if(x)
     {
        document.mform.action="name101_del.jsp?type=1";
        document.mform.method="post";
        document.mform.submit();
     } 
  }           
  ...
  <tr>
    ...
    <td colspan="3">
      <select name="organization">
         <option value="nursery" <%=(query.getOrganization().equals("nursery") ? "selected" : "")%>>托兒所</option>
         <option value="kindergarten" <%=(query.getOrganization().equals("kindergarten") ? "selected" : "")%>>幼稚園</option>
         <option value="primaryschool" <%=(query.getOrganization().equals("primaryschool") ? "selected" : "")%>>國小</option>
      </select>
    </td>
  </tr>
  <tr class="tr">
