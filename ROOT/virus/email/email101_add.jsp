...
<script>
  ...
  function save()
  {
     ...
     document.mform.action = "email101_addsave.jsp";
     document.mform.method = "post";
     document.mform.submit();
  }    
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <tr class="tr">
    ...
    <td colspan="3">
      <input name="liaisonper" type="text" class="lInput01" size="20" maxlength="100"/>
    </td>
  </tr>
  <tr class="tr">
    <td class="T12b"><span class="T12red">※</span>E-Mail</td>
    <td colspan="3">
      <input name="liaisonemail" type="text" class="lInput01" size="60" maxlength="100"/>
    </td>
  </tr>
  <tr>
    <th >&nbsp;</th>
