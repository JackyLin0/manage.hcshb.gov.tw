...
<script>
  ...
  function save()
  {
     ...
     document.mform.action = "school101_addsave.jsp";
     document.mform.method = "post";
     document.mform.submit();
  }    
</script>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <tr class="tr">
    ...
    <td colspan="3">
      <input name="schoolname" type="text" class="lInput01" size="70" maxlength="50"/>
  ...
  <tr class="tr">
    ...
    <td colspan="3">
      <input name="uid" type="text" class="lInput01" size="20" maxlength="10"/>
  ...
  <tr>
    ...
    <td colspan="3">
      <input name="liaisonper" type="text" class="lInput01" size="20" maxlength="20"/>
  ...
  <tr class="tr">
    ...
    <td colspan="3">
      <input name="liaisontel" type="text" class="lInput01" size="20" maxlength="20"/>
    </td>
  </tr>    
  <tr>
    <th >&nbsp;</th>
