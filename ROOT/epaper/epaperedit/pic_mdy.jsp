...
<%
  ...
  EpaperUploadData query = new EpaperUploadData();
	    ...
	    <tr class="tr">
	      ...
	      <td class="T12b">
	        ...
	        <%
	          ...
	          if ( query.getImagemagick() != null && !query.getImagemagick().equals("null") && !query.getImagemagick().equals("") ) {  %>
	        	  <br><br><span class="T10" valign="center"><img src="../../uploaddowndoc?file=/<%=java.net.URLEncoder.encode(msfile,"UTF-8")%>&flag=epaper" alt="<%=query.getExpfile()%>" border="0"/>&nbsp;&nbsp;【原圖片檔名】：<a href="../../uploaddowndoc?file=/<%=java.net.URLEncoder.encode(query.getServerfile(),"UTF-8")%>&flag=epaper"><%=query.getClientfile()%></a></span>
	          <%}else{%>
	        	  <br><br><span class="T10" valign="center"><img src="../../showimage?file=/<%=java.net.URLEncoder.encode(msfile,"UTF-8")%>&flag=epaper&w=170&h=200" alt="<%=query.getExpfile()%>" border="0"/>&nbsp;&nbsp;【原圖片檔名】：<a href="../../uploaddowndoc?file=/<%=java.net.URLEncoder.encode(query.getServerfile(),"UTF-8")%>&flag=epaper"><%=query.getClientfile()%></a></span>
	          <%}%>	
