...
<!--
程式名稱：epaperedit101_addsave.jsp
說明：電子報派送編輯
開發者：chmei
開發日期：97.03.17
修改者：
...
<%
  ...
  String periodicaly = ( String )request.getParameter( "periodicaly" );
  String periodicalm = ( String )request.getParameter( "periodicalm" );
  String periodical = periodicaly + periodicalm;
  ...
  <%}else{
	  ...
	  if ( rtn == false ) {
		  ...
		  program = "epaperedit101_add.jsp";
	  }else{
		  serno = obj.getSerno();
		  program = "epaperedit101_continue.jsp";
	  }
