...
<script>
  ...
  function mdy(serno){
     document.fileform.serno.value = serno;
...
<%
  ...
  EpaperUploadData qupload = new EpaperUploadData();    
  ArrayList<Object> qfiles = qupload.findByday();
  ...
  String path = upload.getProperty("epaperpath");
  path = path.replace('\\','/');
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  <tr align="center">
    <th width="5%">&nbsp;</th>
    <th width="5%"><%=lang.getDel()%></th>
    <th width="45%" align="center"><%=lang.getPicname()%></th>
    <th width="45%" align="left"><%=lang.getPicexp()%></th>
  </tr>
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	EpaperUploadData qfile = ( EpaperUploadData )qfiles.get( i ); %>
    	<tr>
    	  <td colspan="3">&nbsp;</td>
    	</tr>
    	<tr onMouseOver="this.style.backgroundColor='#f4f4f4';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#ffffff';">
    	  ...
    	  <%
    	    String filedata = qfile.getSerno();
    	  ...
    	  <td align="center" width="40%">
    	    <%
    	      if ( qfile.getImagemagick() != null && !qfile.getImagemagick().equals("null") && !qfile.getImagemagick().equals("") ) {  %>
    	    	  <a href="../../uploaddowndoc?file=/<%=java.net.URLEncoder.encode(qfile.getServerfile(),"UTF-8")%>&flag=epaper"><img src="../../uploaddowndoc?file=/<%=java.net.URLEncoder.encode(msfile,"UTF-8")%>&flag=epaper" alt="<%=qfile.getExpfile()%>" border="0"/></a>
    	      <%}else{%>
    	    	  <a href="../../uploaddowndoc?file=/<%=java.net.URLEncoder.encode(qfile.getServerfile(),"UTF-8")%>&flag=epaper"><img src="../../showimage?file=/<%=java.net.URLEncoder.encode(msfile,"UTF-8")%>&flag=epaper&w=160&h=200" alt="<%=qfile.getExpfile()%>" border="0"/></a>
    	      <%}%>
    	  </td>      
    	  <td align="left"><a href="javascript:mdy('<%=qfile.getSerno()%>')"><%=mexppic%></a></td>
    	</tr>
    	<tr>
    	  <td colspan="3">&nbsp;</td>
    	</tr>
