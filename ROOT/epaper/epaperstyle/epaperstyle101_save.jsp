...
<%
  ...
  if ( left2 != null && !left2.equals("null") && !left2.equals("") ) {
	  if ( allleft.equals("") )
		  allleft = left2 + "||left2";
	  else
  ...
  if ( left3 != null && !left3.equals("null") && !left3.equals("") ) {
	  if ( allleft.equals("") )
		  allleft = left3 + "||left3";
	  else
  ...
  if ( middle2 != null && !middle2.equals("null") && !middle2.equals("") ) {
	  if ( allmiddle.equals("") )
  ...
  if ( middle3 != null && !middle3.equals("null") && !middle3.equals("") ) {
	  if ( allmiddle.equals("") )
  ...
  if ( middle4 != null && !middle4.equals("null") && !middle4.equals("") ) {
	  if ( allmiddle.equals("") )
  ...
  if ( middle5 != null && !middle5.equals("null") && !middle5.equals("") ) {
	  if ( allmiddle.equals("") )
