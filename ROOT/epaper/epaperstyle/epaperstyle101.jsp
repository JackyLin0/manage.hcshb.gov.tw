  ...
  <tr onMouseOver="this.style.backgroundColor='#f4f4f4';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#ffffff';">
    ...
    <td>
      <select name="middle2">
        ...
        <%
          if ( qlists != null ) {
        	  boolean rtn = query.load("middle",2);
        	  for ( int i=0; i<rcount; i++ ) {
        		  EpaperStyleData qlist = ( EpaperStyleData )qlists.get( i );
        		  String isSelected = "";
        		  if ( rtn ) {
  ...
  <tr onMouseOver="this.style.backgroundColor='#f4f4f4';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#ffffff';">
    ...
    <td>
      <select name="middle3">
        ...
        <%
          if ( qlists != null ) { 
        	  boolean rtn = query.load("middle",3);
        	  for ( int i=0; i<rcount; i++ ) {
        		  EpaperStyleData qlist = ( EpaperStyleData )qlists.get( i );
        		  String isSelected = "";
        		  if ( rtn ) {
  ...
  <tr onMouseOver="this.style.backgroundColor='#f4f4f4';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#ffffff';">
    ...
    <td>
      <select name="middle4">
        ...
        <%
          if ( qlists != null ) { 
        	  boolean rtn = query.load("middle",4);
        	  for ( int i=0; i<rcount; i++ ) {
        		  EpaperStyleData qlist = ( EpaperStyleData )qlists.get( i );
        		  String isSelected = "";
        		  if ( rtn ) {
  ...
  <tr onMouseOver="this.style.backgroundColor='#f4f4f4';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#ffffff';">
    ...
    <td>
      <select name="middle5">
        ...
        <%
          if ( qlists != null ) { 
        	  boolean rtn = query.load("middle",5);
        	  for ( int i=0; i<rcount; i++ ) {
        		  EpaperStyleData qlist = ( EpaperStyleData )qlists.get( i );
        		  String isSelected = "";
        		  if ( rtn ) {
