...
<script>
  ...
  function save(path)
  {
     ...
     document.fileform.action="media_save.jsp?path="+path;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <tr class="tr">
    ...
    <td class="T12b">
      <textarea name="fileexp1" cols="30" rows="3" class="lInput01"></textarea>
  ...
  <tr class="tr">
    ...
    <td class="T12b">
      <textarea name="fileexp2" cols="30" rows="3" class="lInput01"></textarea>
      <span class="T8-5">    (至多150字）</span>
