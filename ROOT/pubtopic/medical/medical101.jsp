...
<%
  ...
  MedicalData query = new  MedicalData();    
  ArrayList<Object> qlists = query.findByday(table,keyword,qpunit,qclass,sdate1,sdate2,websitedn);    
...
<div>
  ...
  <jsp:include page="../../pubprogram/qwebclass.jsp">
      ...
      <jsp:param name="tablename" value="MedicalClass"/>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
  ...
  <%
    ...
    for ( int i = (startpage-1); ( ( i < endpage ) && ( i < rcount ) ); i ++ )  {
    	MedicalData qlist = ( MedicalData )qlists.get( i ); %>
    	<tr onMouseOver="this.style.backgroundColor='#f4f4f4';this.style.cursor='hand';" onMouseOut="this.style.backgroundColor='#ffffff';">
    	  ...
    	  <td align="center"><a href="javascript:file('<%=qlist.getSerno()%>','doc','MedicalFile','<%=path%>','<%=language%>','<%=pagesize%>')"><img src="../../img/file.gif" alt="file" width="16" height="16" border="0" align="middle" /></a></td>
    	  <td align="center"><a href="javascript:file('<%=qlist.getSerno()%>','pic','MedicalFile','<%=path%>','<%=language%>','<%=pagesize%>')"><img src="../../img/Cmd_Save.gif" alt="attachments" width="16" height="16" border="0" align="middle" /></a></td>
    	  <!-- <td align="center"><a href="javascript:file('<%=qlist.getSerno()%>','media','MedicalFile','<%=path%>','<%=language%>','<%=pagesize%>')"><img src="../../img/media1.gif" alt="media" width="16" height="16" border="0" align="middle" /></a></td> -->
    	</tr> 
