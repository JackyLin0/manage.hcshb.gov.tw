...
<%
  ...
  <%}else{
	  ...
	  for ( int i=0; i<ary_delno.length; i++ ) {
		  EpidemicData qfile = new EpidemicData();
		  ArrayList<Object> qdels = qfile.findBydel("EpidemicFile",ary_delno[i]);	  
		  int delrcount = qfile.getAllrecordCount();
		  if ( qdels != null ) {
			  for ( int d=0; d<delrcount; d++ ) {
				  EpidemicData qdel = ( EpidemicData )qdels.get( d );
	  ...
	  EpidemicData obj = new EpidemicData();
	...
	<form name="mform" action="epidemic101.jsp" method="post">
