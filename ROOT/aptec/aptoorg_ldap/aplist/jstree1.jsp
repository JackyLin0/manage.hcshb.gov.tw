...
<script>
	...
	var FirstURL = "toptree1.jsp?Level=1"		                <!---Top Level URL--->
	...
	var strFirstLine = "<tr><td colspan=50><img src='../../image/tree.gif'>&nbsp;<a href='../node.jsp?dn=ou=ap_root,o=hcshb,c=tw' target='center'><font fontface='細明體' size=2>應用系統管理</font></a></td></tr>"
	var objOpenWin = top
	<!---系統變數--->
