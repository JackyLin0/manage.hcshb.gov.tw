...
<a class="md" href="javascript:window.location='nodenew.jsp?dn=<%=dn%>'">新增單位</a>			
<a class="md" href="javascript:window.location='leafnew.jsp?dn=<%=dn%>'">新增成員</a>	
     ...
     if ( qdata ) {
    	 while ( qou.next() ) {
    		 ...
    		 if ( dn.equals(ds_root) )
    			 ctitle = "新竹縣政府";
    		 String etitle = qou.getString( "englishtitle" );
    		 if ( etitle == null || etitle.equals("!") )
    			 etitle = "";
    		 String jtitle = qou.getString( "japantitle" );
    		 ...
    		 <tr>
    		   <th colspan="4"><%=ctitle%>--組織設定【<%=qou.getString( "dn" )%>】</th>
    		 </tr>
    		 <tr class="tr">
    		   <td class="T12b" width="30%"><span class="T12red">※</span>局(室)代碼</td>
    		   <td colspan="3">
    		     <input name="ou" type="text" class="lInput01" value="<%=qou.getString( "ou" )%>" size="30" readonly>
    		   </td>
    		 ...
    		 <tr>
    		   ...
    		   <td colspan="3">
    		     <input name="ctitle" type="text" class="lInput01" size="70" value="<%=ctitle%>">
    		   </td>
    		 </tr>
    		 <tr class="tr">
    		   <td class="T12b">局(室)名稱(英文)</td>
    		   <td colspan="3">
    		     <input name="etitle" type="text" class="lInput01" size="70" value="<%=etitle%>">
    		   </td>
    		 </tr> 
    		 <tr>
    		   <td class="T12b">局(室)名稱(日文)</td>
    		   <td colspan="3">
    		     <input name="jtitle" type="text" class="lInput01" size="70" value="<%=jtitle%>">
    		   </td>
    		 </tr>
    	 <%}%>
    	 <tr>
