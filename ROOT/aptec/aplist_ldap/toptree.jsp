...
<%     
  ...
  if ( qou.query( sdn, "dn,sysname,objectclass,ou", "objectclass=aptree", SvLdap.QUERYONELEVEL ) )
  {
  	   while ( qou.next() )
  	   {
  	     ...
  	     <span class="w2"><img src='../image/tree.gif' />&nbsp;<a style=text-Decoration:none href='node.jsp?dn=<%=mdn%>' target='treeright'><%=qou.getString( "sysname" )%></a></span><!,>toptree.jsp?sdn=<%=mdn%><!End>       	  
  	   <%}
  }%>
