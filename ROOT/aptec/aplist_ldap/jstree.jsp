...
<script>
	...
	var strFirstLine = "<tr><td colspan=50><img src='../image/tree.gif'>&nbsp;<a href='node.jsp?dn=ou=ap_root,o=hcshb,c=tw' target='treeright'><font fontface='細明體' size=2>應用系統管理</font></td></tr>"
	var objOpenWin = top
	<!---系統變數--->
