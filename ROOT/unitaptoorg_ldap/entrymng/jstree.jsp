...
<script>
	...
	var FirstURL = "toptree.jsp?Level=1&sdn=<%=pubunitdn%>&unitdn=<%=pubunitdn%>"		                <!---Top Level URL--->
	...
	var strFirstLine = "<tr><td colspan=50><img src='../image/org.gif'>&nbsp;<font fontface='細明體' size=2><%=unitname%></font></td></tr>"
	var objOpenWin = top
	<!---系統變數--->
