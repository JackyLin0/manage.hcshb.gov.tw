...
<%
  ...
  String oldaciuserdnt = ( String )request.getParameter( "oldaciuserdnt" );
  String olduserallow = ( String )request.getParameter( "olduserallow" );
  String oldaci = "";
  if ( !oldaciuserdnt.equals("") ) {
	  String[] ary_oldaciuserdnt = SvString.split(oldaciuserdnt,"$");
	  for ( int i=0; i<ary_oldaciuserdnt.length; i++ ) {
		  if ( oldaci.equals("") ) {
			  oldaci = ";allow(all)(userdn = \"ldap:///" + ary_oldaciuserdnt[i] + "\")";
		  }else{
			  oldaci = oldaci + ";allow(all)(userdn = \"ldap:///" + ary_oldaciuserdnt[i] + "\")";
		  }
	  }
  }
  ...
  String aci = "";
  String aciuser = "";
  String acidn = oldaciuserdnt;
  String userallow = olduserallow;
  String acl = "";
  ...
  String[] ary_acidn = null;
  if ( acidn != null && !acidn.equals("null") )
	  ary_acidn = SvString.split(acidn,"$");
  ...
  for (int cnt=0; cnt<dnlen; cnt++)
  {
     ...
     if (!aduser.equals("delete")) {
		 ...
		 if ( !SvString.contain(ary_acidn,array_aciuserdn[cnt]) ) {
             if ( !userallow.equals("") )
