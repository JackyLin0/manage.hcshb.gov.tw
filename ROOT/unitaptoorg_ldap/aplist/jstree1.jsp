...
// out.println("websitedn:"+websitedn);
  //尋找該單位網站DN
  UnitManagerData query = new UnitManagerData();
//   boolean rtn = query.load(pubunitdn);
//   String websitedn = "";
//   if ( rtn )
// 	  websitedn = query.getWebsitedn();
%>

<script>
	<!---自設變數--->
	var MaxLevel = 50		<!---最大階層數--->
	var FirstURL = "toptree1.jsp?Level=1&websitedn=<%=websitedn%>&unitdn=<%=pubunitdn%>"	  <!---Top Level URL--->
	...
	var strFirstLine = "<tr><td colspan=50><img src='../image/tree.gif'>&nbsp;<font fontface='細明體' size=2>應用系統管理</font></a></td></tr>"
	var objOpenWin = top
	<!---系統變數--->
...
function ShowTree() {
	...
	window.TreeView.document.open()
	window.TreeView.document.write(strHTML)
	window.TreeView.document.close()
}
...
<frameset rows="100%" frameborder="NO" border="0" framespacing="0">
  <frame name="TreeView" src="" marginwidth="5" marginheight="5">
