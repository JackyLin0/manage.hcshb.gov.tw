...
//== PopCalendarXP 7.0.170 Lite Edition,  Copyright 2001-2003 CalendarXP.net, LIMING WENG
//== Release date: 2003.04.24    website - http://www.calendarxp.net
...
var MILLIDAY=86400000, giResizeDelay=50;
...
var gBegin=[<%=request.getParameter("start_year")%>,1,1];	// calendar date range begin from [Year,Month,Date]. Using gToday here will make it start from today.
var gEnd=[<%=request.getParameter("end_year")%>,12,31];	// calendar date range end at [Year,Month,Date]
...
<body leftmargin=0 topmargin=0 marginwidth=0 marginheight=0 hspace=0 vspace=0 onselectstart="return false" ondraggesture="return false" ondragstart="return false" oncontextmenu="return false" onmouseout="_mouseout=true" onmouseover="_mouseout=false" onmouseup="_lastDrag=null;self.status='PopCalendarXP 7.0 Lite Edition, Copyright 2001-2003 CalendarXP.net';return true;">
<script type='text/javascript'>
...
function fSetCal(y,m,d,bTriggerOnChg) {
	...
	setTimeout("fResize()",giResizeDelay);
	return true;
}
