...
<%
	...
	ResultSet rs = f.query("select * from parameter_sheet where sn = "+String.valueOf(sn)) ;
	...
	if( f.cstr(request.getParameter("mode")).equals("save") && ( allow_insert || allow_update ) )
	{
		...
		rs.updateString("val",request.getParameter("val")) ;
...
<table width="100%" cellspacing="0" cellpadding="2" border="1" align="center">
	...
	<tr>
		<td>數值：</td>
		<td><input type="text" name="val" size="30" value="<%=f.field(rs,"val")%>"></td>
	</tr>
	<tr>
		<td>說明：</td>
		<td><input type="text" name="caption" size="70" value="<%=f.field(rs,"caption")%>"></td>
	</tr>
